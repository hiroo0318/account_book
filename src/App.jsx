...
export default function App() {
  ...
  return <main className="app-shell"><section className="ledger" aria-label="월별 식비 가계부">
    ...
    <section className="summary-card" aria-label="이번 달 사용 금액"><p>이번 달 사용 금액</p><strong>{formatMoney(total)}</strong><button className="add-button" type="button" onClick={openAddSheet}><Icon name="plus" /> <span>추가</span></button></section>
